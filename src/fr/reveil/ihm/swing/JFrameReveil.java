...
public class JFrameReveil extends JFrame 
{
	...
	public JFrameReveil()
	{
		...
		// Mise au mode Horloge � la construction
		this.setModeClock();
	...
	public void setModeAlarm()
	{
		...
		borderReveil = BorderFactory.createLineBorder( colorReveil, 1 );
		borderReveil = BorderFactory.createTitledBorder( borderReveil, "R�veil", TitledBorder.LEFT, TitledBorder.TOP, fontConsolasItalicBold014 );
		jPanelReveil.setBorder( borderReveil );
